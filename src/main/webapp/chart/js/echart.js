$(function () {
    ...
    function echart_1() {
    	...
    	var carName=new Array()
    	  $.ajax({  
    	        type:'POST',  
    	        url:'/Car_Monitor_Platform/CarTypeStatistic',        
    	        cache:false,  
    	        dataType:'json',
    	        async:false,
       ...
       // debugger;
        option = {
            ...
            color: ['#0035f9', '#f36f8a', '#ffff43', '#25f3e6','#efe39b','#25f3e6','#ffffff'],
            legend: { //图例组件，颜色和名字
                left: '65%',
                top: '95',
                orient: 'vertical',
    ...
    function echart_2() {
        ...
        $.ajax({  
	        type:'POST',  
	        url:'/Car_Monitor_Platform/CarStatusStatistic',        
	        cache:false,  
	        dataType:'json',
	        async:false,
	        success:function(data){ 
	        	CarStatusCount=data
	        	console.log(CarStatusCount);
	       
	        }  
	    });  
        var data=CarStatusCount;
        option = {
            tooltip: {
                trigger: 'axis',
    ...
    function echart_3() {
        ...
        var serieData = [];
        var metaDate = [
            [60, 30, 20, 10, 300, 230, 130, 170,140, 280, 300, 230,120, 140, 100, 120, 300, 230, 130, 170,140, 120, 300, 230]
